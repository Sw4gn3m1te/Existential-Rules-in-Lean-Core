    ...
    | .succ j =>
      ...
      match prev_node_eq : prev_node with
        ...
        | .some cn =>
          ...
          let trg_ex_dec := Classical.propDecidable (exists_trigger_opt_fs_core kb.rules (prev_node.get (Option.isSome_of_mem prev_node_eq)) (cb.branch.infinite_list j.succ))
